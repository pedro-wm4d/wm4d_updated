...
class FakeSoapPayloadsAndLogsProvider
{
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'getCreativesByStatement-expected-soapxmllog.txt');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'getCreativesByStatement-scrubbed-soapxmllog.txt');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'getCreativesByStatement-request.xml');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'getCreativesByStatement-request-httpheaders.txt');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'getCreativesByStatement-response.xml');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'getCreativesByStatement-response-httpheaders.txt');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'createAdUnits-refs-request.xml');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'createAdUnits-refs-replaced-request.xml');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'mutate-expected-soapxmllog.txt');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'mutate-scrubbed-soapxmllog.txt');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'mutate-request.xml');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'mutate-request-httpheaders.txt');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'mutate-response.xml');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'mutate-response-httpheaders.txt');
    }
}