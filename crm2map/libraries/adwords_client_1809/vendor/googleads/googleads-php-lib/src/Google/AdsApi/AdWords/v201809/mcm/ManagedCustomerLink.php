...
class ManagedCustomerLink
{
    ...
    {
        $this->managerCustomerId = !is_null($managerCustomerId) && PHP_INT_SIZE === 4 ? floatval($managerCustomerId) : $managerCustomerId;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->clientCustomerId = !is_null($clientCustomerId) && PHP_INT_SIZE === 4 ? floatval($clientCustomerId) : $clientCustomerId;
        return $this;
    }
    /**
     * @return string
