...
class ExtensionFeedItem
{
     ...
     */
    private $parameterMap = array('ExtensionFeedItem.Type' => 'ExtensionFeedItemType');
    /**
     * @param int $feedId
    ...
    {
        $this->feedItemId = !is_null($feedItemId) && PHP_INT_SIZE === 4 ? floatval($feedItemId) : $feedItemId;
        return $this;
    }
    /**
     * @return string
