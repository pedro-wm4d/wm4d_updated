...
final class ReportDownloadError extends ApiError
{
    ...
    {
        parent::__construct($fieldPath, null, $trigger, $errorString, $apiErrorType);
    }
    /**
    ...
    {
        return sprintf('fieldPath: %s; trigger: %s; errorString: %s', $this->getFieldPath(), $this->getTrigger(), $this->getErrorString());
    }
}