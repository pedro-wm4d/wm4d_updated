...
class TemplateAd extends \Google\AdsApi\AdWords\v201809\cm\Ad
{
    ...
    {
        $this->templateId = !is_null($templateId) && PHP_INT_SIZE === 4 ? floatval($templateId) : $templateId;
        return $this;
    }
    /**
    ...
    {
        $this->originAdId = !is_null($originAdId) && PHP_INT_SIZE === 4 ? floatval($originAdId) : $originAdId;
        return $this;
    }
}