...
final class ReportDownloadResult
{
     ...
     */
    public function __construct(ResponseInterface $response, ReportDownloadResultDelegate $reportDownloadResultDelegate = null, AdsUtilityRegistry $adsUtilityRegistry = null)
    {
        $this->reportDownloadResultDelegate = $reportDownloadResultDelegate === null ? new ReportDownloadResultDelegate($response) : $reportDownloadResultDelegate;
