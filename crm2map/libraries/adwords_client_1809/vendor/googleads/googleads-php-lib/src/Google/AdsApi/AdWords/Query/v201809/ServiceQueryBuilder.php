...
final class ServiceQueryBuilder
{
     ...
     */
    public function __construct(ServiceQueryBuilderDelegate $delegate = null, AdsUtilityRegistryInterface $utilityRegistry = null)
    {
        $this->delegate = is_null($delegate) ? new ServiceQueryBuilderDelegate() : $delegate;
        $this->utilityRegistry = is_null($utilityRegistry) ? AdsUtilityRegistry::getInstance() : $utilityRegistry;
    }
    /**
    ...
    public static function copyFrom(ServiceQueryBuilder $otherInstance)
    {
        ...
        $copyDelegate = ServiceQueryBuilderDelegate::copyFrom($otherInstance->delegate, $copyBuilder);
