...
final class ReportQueryWhereBuilder implements WhereBuilderInterface
{
     ...
     */
    private function __construct(ReportQueryBuilder $queryBuilder, ExpressionBuilder $expressionBuilder)
    {
     ...
     */
    public static function createWithField($field, ReportQueryBuilder $queryBuilder)
    {
     ...
     */
    public static function copyFrom(ReportQueryWhereBuilder $otherInstance, ReportQueryBuilder $queryBuilder)
    {
