...
final class ReportQueryBuilder
{
     ...
     */
    public function __construct(ReportQueryBuilderDelegate $delegate = null, AdsUtilityRegistryInterface $utilityRegistry = null)
    {
        $this->delegate = is_null($delegate) ? new ReportQueryBuilderDelegate() : $delegate;
    ...
    public static function copyFrom(ReportQueryBuilder $otherInstance)
    {
        ...
        $copyDelegate = ReportQueryBuilderDelegate::copyFrom($otherInstance->delegate, $copyBuilder);
