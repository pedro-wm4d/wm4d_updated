...
final class OAuth2TokenBuilder implements AdsBuilder
{
    ...
    public function build()
    {
        ...
        if ($this->jsonKeyFilePath !== null) {
            return new ServiceAccountCredentials($this->scopes, $this->jsonKeyFilePath, $this->impersonatedEmail);
        } else {
            return new UserRefreshCredentials(null, array('client_id' => $this->clientId, 'client_secret' => $this->clientSecret, 'refresh_token' => $this->refreshToken));
        }
    }
    /**
    ...
    {
        if (($this->jsonKeyFilePath !== null || $this->scopes !== null) && ($this->clientId !== null || $this->clientSecret !== null || $this->refreshToken !== null)) {
        ...
        } elseif ($this->clientId === null || $this->clientSecret === null || $this->refreshToken === null) {
            throw new InvalidArgumentException('All of \'clientId\', ' . '\'clientSecret\', and \'refreshToken\' must be set when using ' . 'installed/web application flow.');
        }
    }
    /**
