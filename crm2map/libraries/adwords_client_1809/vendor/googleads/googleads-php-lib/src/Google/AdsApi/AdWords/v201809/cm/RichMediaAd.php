 ...
 */
abstract class RichMediaAd extends \Google\AdsApi\AdWords\v201809\cm\Ad
{
    /**
     * @var string $name
     */
    ...
    /**
     * @param string $name
     * @return \Google\AdsApi\AdWords\v201809\cm\RichMediaAd
     */
    ...
    {
        $this->certifiedVendorFormatId = !is_null($certifiedVendorFormatId) && PHP_INT_SIZE === 4 ? floatval($certifiedVendorFormatId) : $certifiedVendorFormatId;
        return $this;
    }
    /**
     * @return string
