...
final class AdsGuzzleProxyHttpHandler
{
     ...
     */
    public function __construct(AdsSession $session, ClientInterface $httpClient = null)
    {
    ...
    {
        $requestOptions = empty($this->proxyUrl) ? array() : array(RequestOptions::PROXY => $this->proxyUrl);
