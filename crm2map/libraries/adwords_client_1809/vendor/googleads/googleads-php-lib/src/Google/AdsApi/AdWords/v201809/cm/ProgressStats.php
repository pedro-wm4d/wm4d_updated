...
class ProgressStats
{
    ...
    {
        $this->numOperationsExecuted = !is_null($numOperationsExecuted) && PHP_INT_SIZE === 4 ? floatval($numOperationsExecuted) : $numOperationsExecuted;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->numOperationsSucceeded = !is_null($numOperationsSucceeded) && PHP_INT_SIZE === 4 ? floatval($numOperationsSucceeded) : $numOperationsSucceeded;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->numResultsWritten = !is_null($numResultsWritten) && PHP_INT_SIZE === 4 ? floatval($numResultsWritten) : $numResultsWritten;
        return $this;
    }
}