...
use Google\AdsApi\AdWords\v201806\cm\MutateResult;
use Google\AdsApi\AdWords\v201806\cm\Operation;
...
final class BatchJobs
{
     ...
     *     registry
     */
    public function __construct(AdWordsSession $session, Client $httpClient = null, $mutateResultClassName = null, BatchJobsDelegate $batchJobsDelegate = null, AdsUtilityRegistry $adsUtilityRegistry = null)
    {
        $this->batchJobsDelegate = $batchJobsDelegate === null ? new BatchJobsDelegate($session, $httpClient, $mutateResultClassName) : $batchJobsDelegate;
    ...
    public function uploadBatchJobOperations(array $operations, $uploadUrl)
    {
        ...
        return $this->batchJobsDelegate->uploadBatchJobOperations($operations, $uploadUrl);
    }
    /**
    ...
    {
        $this->adsUtilityRegistry->addUtility(AdsUtility::BATCH_JOBS);
        return $this->batchJobsDelegate->uploadIncrementalBatchJobOperations($operations, $batchJobUploadStatus);
    }
    /**
    ...
    {
        $this->adsUtilityRegistry->addUtility(AdsUtility::BATCH_JOBS);
        return $this->batchJobsDelegate->closeIncrementalUpload($batchJobUploadStatus);
    }
    /**
