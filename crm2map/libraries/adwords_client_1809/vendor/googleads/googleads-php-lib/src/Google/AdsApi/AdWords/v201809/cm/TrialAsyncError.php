...
class TrialAsyncError
{
    ...
    {
        $this->trialId = !is_null($trialId) && PHP_INT_SIZE === 4 ? floatval($trialId) : $trialId;
        return $this;
    }
    /**
    ...
    {
        $this->trialCampaignId = !is_null($trialCampaignId) && PHP_INT_SIZE === 4 ? floatval($trialCampaignId) : $trialCampaignId;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->trialAdGroupId = !is_null($trialAdGroupId) && PHP_INT_SIZE === 4 ? floatval($trialAdGroupId) : $trialAdGroupId;
        return $this;
    }
    /**
     * @return int
