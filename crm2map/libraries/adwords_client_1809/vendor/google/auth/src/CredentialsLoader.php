...
abstract class CredentialsLoader implements FetchAuthTokenInterface
{
     ...
     */
    public static function makeHttpClient(FetchAuthTokenInterface $fetcher, array $httpClientOptions = array(), callable $httpHandler = null, callable $tokenCallback = null)
    {
        ...
        switch ($version[0]) {
            ...
            case '6':
                ...
                return new \GuzzleHttp\Client(array('handler' => $stack, 'auth' => 'google_auth') + $httpClientOptions);
            default:
