...
class UserRefreshCredentials extends CredentialsLoader
{
    ...
    public function __construct($scope, $jsonKey)
    {
        ...
        $this->auth = new OAuth2(array('clientId' => $jsonKey['client_id'], 'clientSecret' => $jsonKey['client_secret'], 'refresh_token' => $jsonKey['refresh_token'], 'scope' => $scope, 'tokenCredentialUri' => self::TOKEN_CREDENTIAL_URI));
