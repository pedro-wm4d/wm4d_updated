...
class ServerRequest extends Request implements ServerRequestInterface
{
     ...
     */
    public function __construct($method, $uri, array $headers = array(), $body = null, $version = '1.1', array $serverParams = array())
    {
    ...
    private static function normalizeNestedFileSpec(array $files = array())
    {
        ...
        foreach (array_keys($files['tmp_name']) as $key) {
            $spec = array('tmp_name' => $files['tmp_name'][$key], 'size' => $files['size'][$key], 'error' => $files['error'][$key], 'name' => $files['name'][$key], 'type' => $files['type'][$key]);
