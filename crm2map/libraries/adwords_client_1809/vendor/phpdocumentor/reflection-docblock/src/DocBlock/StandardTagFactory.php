...
final class StandardTagFactory implements TagFactory
{
    ...
    public function registerTagHandler($tagName, $handler)
    {
        ...
        Assert::implementsInterface($handler, __CLASS__);
    ...
    private function createTag($body, $name, TypeContext $context)
    {
        ...
        return call_user_func_array(array($handlerClassName, 'create'), $arguments);
    }
    /**
    ...
    {
##        $locator = array_merge($this->serviceLocator, array('name' => $tagName, 'body' => $tagBody, TypeContext::class => $context));
##        return $locator;
        return null;
    }
    /**
