...
class GetSetMethodNormalizer extends AbstractObjectNormalizer
{
    ...
    private function isGetMethod(\ReflectionMethod $method)
    {
        ...
        return !$method->isStatic() && ((0 === strpos($method->name, 'get') && 3 < $methodLength || 0 === strpos($method->name, 'is') && 2 < $methodLength || 0 === strpos($method->name, 'has') && 3 < $methodLength) && 0 === $method->getNumberOfRequiredParameters());
    }
    /**
     * {@inheritdoc}
     */
    ...
    protected function setAttributeValue($object, $attribute, $value, $format = null, array $context = array())
    {
        ...
        if (!isset(self::$setterAccessibleCache[$key])) {
            self::$setterAccessibleCache[$key] = \is_callable(array($object, $setter)) && !(($tmp = new \ReflectionMethod($object, $setter)) ? $tmp->isStatic() : $tmp->isStatic());
        }
