...
class RedirectMiddleware
{
    ...
    public static $defaultSettings = array('max' => 5, 'protocols' => array('http', 'https'), 'strict' => false, 'referer' => false, 'track_redirects' => false);
    /** @var callable  */
    private $nextHandler;
    /**
    ...
    public function __invoke(RequestInterface $request, array $options)
    {
        ...
        return $fn($request, $options)->then(function (ResponseInterface $response) use($request, $options, $that) {
            return $that->checkRedirect($request, $options, $response);
        });
    }
    /**
     * @param RequestInterface  $request
