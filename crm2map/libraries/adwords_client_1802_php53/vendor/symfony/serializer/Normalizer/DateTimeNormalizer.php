...
class DateTimeNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    private $format;
    private $timezone;
    private static $supportedTypes = array(\DateTimeInterface::class => true, \DateTimeImmutable::class => true, \DateTime::class => true);
    /**
     * @param string             $format
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $timezone) {
            $object = ($tmp = new \DateTimeImmutable('@' . $object->getTimestamp())) ? $tmp->setTimezone($timezone) : $tmp->setTimezone($timezone);
        }
