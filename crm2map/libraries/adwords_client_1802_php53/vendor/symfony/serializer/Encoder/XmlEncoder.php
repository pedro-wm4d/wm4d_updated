...
class XmlEncoder extends SerializerAwareEncoder implements EncoderInterface, DecoderInterface, NormalizationAwareInterface
{
     ...
     * @return bool
     */
    protected final function appendText(\DOMNode $node, $val)
    {
     ...
     * @return bool
     */
    protected final function appendCData(\DOMNode $node, $val)
    {
     ...
     * @return bool
     */
    protected final function appendDocumentFragment(\DOMNode $node, $fragment)
    {
    ...
    {
        return isset($context['xml_type_cast_attributes']) ? (bool) $context['xml_type_cast_attributes'] : true;
    }
    /**
    ...
    private function createDomDocument(array $context)
    {
        ...
        $xmlOptions = array('xml_format_output' => 'formatOutput', 'xml_version' => 'xmlVersion', 'xml_encoding' => 'encoding', 'xml_standalone' => 'xmlStandalone');
