...
class BidLandscapeLandscapePoint
{
    ...
    {
        $this->clicks = !is_null($clicks) && PHP_INT_SIZE === 4 ? floatval($clicks) : $clicks;
        return $this;
    }
    /**
     * @return \Google\AdsApi\AdWords\v201802\cm\Money
    ...
    {
        $this->promotedImpressions = !is_null($promotedImpressions) && PHP_INT_SIZE === 4 ? floatval($promotedImpressions) : $promotedImpressions;
        return $this;
    }
    /**
     * @return \Google\AdsApi\AdWords\v201802\cm\Money
    ...
    {
        $this->totalLocalImpressions = !is_null($totalLocalImpressions) && PHP_INT_SIZE === 4 ? floatval($totalLocalImpressions) : $totalLocalImpressions;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->totalLocalClicks = !is_null($totalLocalClicks) && PHP_INT_SIZE === 4 ? floatval($totalLocalClicks) : $totalLocalClicks;
        return $this;
    }
    /**
     * @return \Google\AdsApi\AdWords\v201802\cm\Money
    ...
    {
        $this->totalLocalPromotedImpressions = !is_null($totalLocalPromotedImpressions) && PHP_INT_SIZE === 4 ? floatval($totalLocalPromotedImpressions) : $totalLocalPromotedImpressions;
        return $this;
    }
}