...
class UserList
{
     ...
     */
    private $parameterMap = array('UserList.Type' => 'UserListType');
    /**
     * @param int $id
    ...
    {
        $this->membershipLifeSpan = !is_null($membershipLifeSpan) && PHP_INT_SIZE === 4 ? floatval($membershipLifeSpan) : $membershipLifeSpan;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->size = !is_null($size) && PHP_INT_SIZE === 4 ? floatval($size) : $size;
        return $this;
    }
    /**
     * @return string
    ...
    {
        $this->sizeForSearch = !is_null($sizeForSearch) && PHP_INT_SIZE === 4 ? floatval($sizeForSearch) : $sizeForSearch;
        return $this;
    }
    /**
     * @return string
