...
class ConversionTrackingSettings
{
    ...
    {
        $this->effectiveConversionTrackingId = !is_null($effectiveConversionTrackingId) && PHP_INT_SIZE === 4 ? floatval($effectiveConversionTrackingId) : $effectiveConversionTrackingId;
        return $this;
    }
    /**
     * @return boolean
