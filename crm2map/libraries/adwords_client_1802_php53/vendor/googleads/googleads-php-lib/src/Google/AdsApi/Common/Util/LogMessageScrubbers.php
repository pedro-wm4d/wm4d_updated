...
final class LogMessageScrubbers
{
     ...
     */
    public static function scrubRequestHttpHeaders($httpHeaders, array $headersToScrub)
    {
     ...
     *     headers
     */
    public static function scrubRequestSoapHeaders($soapXml, array $headersToScrub)
    {
        foreach ($headersToScrub as $header) {
     ...
     *     headers
     */
    public static function scrubRequestSoapBodyTags($soapXml, array $tagsToScrub)
    {
