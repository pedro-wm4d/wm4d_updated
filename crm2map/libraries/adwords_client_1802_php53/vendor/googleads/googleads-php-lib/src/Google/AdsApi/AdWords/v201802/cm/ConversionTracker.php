...
abstract class ConversionTracker
{
     ...
     */
    private $parameterMap = array('ConversionTracker.Type' => 'ConversionTrackerType');
    /**
     * @param int $id
    ...
    {
        $this->originalConversionTypeId = !is_null($originalConversionTypeId) && PHP_INT_SIZE === 4 ? floatval($originalConversionTypeId) : $originalConversionTypeId;
        return $this;
    }
    /**
     * @return string
    ...
    {
        $this->conversionTypeOwnerCustomerId = !is_null($conversionTypeOwnerCustomerId) && PHP_INT_SIZE === 4 ? floatval($conversionTypeOwnerCustomerId) : $conversionTypeOwnerCustomerId;
        return $this;
    }
    /**
     * @return int
