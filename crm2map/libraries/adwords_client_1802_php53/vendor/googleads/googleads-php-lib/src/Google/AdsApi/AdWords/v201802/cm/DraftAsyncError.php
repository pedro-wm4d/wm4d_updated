...
class DraftAsyncError
{
    ...
    {
        $this->draftId = !is_null($draftId) && PHP_INT_SIZE === 4 ? floatval($draftId) : $draftId;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->draftCampaignId = !is_null($draftCampaignId) && PHP_INT_SIZE === 4 ? floatval($draftCampaignId) : $draftCampaignId;
        return $this;
    }
    /**
    ...
    {
        $this->draftAdGroupId = !is_null($draftAdGroupId) && PHP_INT_SIZE === 4 ? floatval($draftAdGroupId) : $draftAdGroupId;
        return $this;
    }
}