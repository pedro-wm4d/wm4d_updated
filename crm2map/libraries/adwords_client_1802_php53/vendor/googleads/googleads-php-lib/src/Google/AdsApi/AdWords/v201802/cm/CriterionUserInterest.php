...
class CriterionUserInterest extends \Google\AdsApi\AdWords\v201802\cm\Criterion
{
    ...
    {
        $this->userInterestId = !is_null($userInterestId) && PHP_INT_SIZE === 4 ? floatval($userInterestId) : $userInterestId;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->userInterestParentId = !is_null($userInterestParentId) && PHP_INT_SIZE === 4 ? floatval($userInterestParentId) : $userInterestParentId;
        return $this;
    }
    /**
     * @return string
