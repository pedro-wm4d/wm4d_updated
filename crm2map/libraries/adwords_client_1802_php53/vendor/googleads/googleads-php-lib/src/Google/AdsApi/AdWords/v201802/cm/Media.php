...
class Media
{
     ...
     */
    private $parameterMap = array('Media.Type' => 'MediaType');
    /**
     * @param int $mediaId
     * @param string $type
    ...
    {
        $this->mediaId = !is_null($mediaId) && PHP_INT_SIZE === 4 ? floatval($mediaId) : $mediaId;
        return $this;
    }
    /**
     * @return string
    ...
    {
        $this->referenceId = !is_null($referenceId) && PHP_INT_SIZE === 4 ? floatval($referenceId) : $referenceId;
        return $this;
    }
    /**
    ...
    {
        $this->fileSize = !is_null($fileSize) && PHP_INT_SIZE === 4 ? floatval($fileSize) : $fileSize;
        return $this;
    }
    /**
     * @return string
