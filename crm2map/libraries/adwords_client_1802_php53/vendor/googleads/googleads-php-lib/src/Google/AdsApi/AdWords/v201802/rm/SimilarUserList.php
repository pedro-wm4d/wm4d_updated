...
class SimilarUserList extends \Google\AdsApi\AdWords\v201802\rm\UserList
{
    ...
    {
        $this->seedUserListId = !is_null($seedUserListId) && PHP_INT_SIZE === 4 ? floatval($seedUserListId) : $seedUserListId;
        return $this;
    }
    /**
     * @return string
    ...
    {
        $this->seedListSize = !is_null($seedListSize) && PHP_INT_SIZE === 4 ? floatval($seedListSize) : $seedListSize;
        return $this;
    }
}