...
class Vertical extends \Google\AdsApi\AdWords\v201802\cm\Criterion
{
    ...
    {
        $this->verticalId = !is_null($verticalId) && PHP_INT_SIZE === 4 ? floatval($verticalId) : $verticalId;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->verticalParentId = !is_null($verticalParentId) && PHP_INT_SIZE === 4 ? floatval($verticalParentId) : $verticalParentId;
        return $this;
    }
    /**
     * @return string[]
