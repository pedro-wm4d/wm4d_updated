...
class FakeHttpPayloadsAndLogsProvider
{
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'downloadReport-awql-log.txt');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'downloadReport-reportdefinition-log.txt');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'downloadReport-scrubbed-log.txt');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'downloadReport-logwitherrors.txt');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'downloadReport-awql.txt');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'downloadReport-encoded-reportdefinition.txt');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'downloadReport-result.txt');
    }
}