...
class AdsSoapClient extends SoapClient
{
    ...
    private static $SOAP_FAULT_NAME_TO_TYPE_MAP = array(
...
/*		$options [ 'stream_context'] = stream_context_create(['ssl' => ['verify_peer'=>false]]);*/
/*		$options [ 'proxy_host' ]    = "localhost";*/
//                $options [ 'local_cert' ]   = "D:/wwwroot/apache/api/adwords/v201802/cert.pem";  
//                $options [ 'trace' ]   = 1;  
...
//print_r($httpHeaders);exit;

        stream_context_set_option(
            $this->streamContext,
            $existingStreamContextOptions
        );
//print_r(stream_context_get_options($this->streamContext));exit;
...
//print_r($existingStreamContextOptions);
//print_r($input_headers);exit;
/*
echo "                $function_name,
                $options,
                $input_headers,
