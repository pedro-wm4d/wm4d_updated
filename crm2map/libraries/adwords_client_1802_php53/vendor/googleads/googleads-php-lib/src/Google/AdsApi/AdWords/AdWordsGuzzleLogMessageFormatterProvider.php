 ...
 */
final class AdWordsGuzzleLogMessageFormatterProvider implements GuzzleLogMessageFormatterProvider
{
    private static $HTTP_HEADERS_TO_SCRUB = array('Authorization', 'developerToken');
    private $session;
     ...
     */
    public function __construct(AdWordsSession $session, $shouldLogResponsePayload, $redactedResponsePayloadMessage = null)
    {
    ...
    {
        return new GuzzleLogMessageFormatter(self::$HTTP_HEADERS_TO_SCRUB, array('clientCustomerId' => $this->session->getClientCustomerId()), $this->shouldLogResponsePayload, $this->redactedResponsePayloadMessage);
    }
}