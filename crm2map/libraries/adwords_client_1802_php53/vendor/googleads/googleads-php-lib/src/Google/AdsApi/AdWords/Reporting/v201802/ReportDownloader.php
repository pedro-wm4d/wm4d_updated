...
{
    private static $REPORT_DOWNLOAD_URL_PATH = '/api/adwords/reportdownload/v201802';
    ...
    private function makeReportRequest(array $requestOptions)
    {
        ...
        try {
            ...
            $reportDownloadErrors = $this->apiErrorSerializer->denormalize($apiErrorList, 'Google\\AdsApi\\AdWords\\Reporting\\v201802\\ReportDownloadError[]');
