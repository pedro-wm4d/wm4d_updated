...
final class BatchJobsDelegate
{
    ...
    private static $MUTATE_RESULT_CLASS_NAME = 'Google\\AdsApi\\AdWords\\v201802\\cm\\MutateResult';
    private $session;
    private $httpClient;
    ...
    {
        $serializedContent = $this->batchJobSerializer->serialize(array('operations' => $operations, '@xmlns:ns1' => 'https://adwords.google.com/api/adwords/cm/v201802', '@xmlns:xsi' => 'http://www.w3.org/2001/XMLSchema-instance'), 'xml');
