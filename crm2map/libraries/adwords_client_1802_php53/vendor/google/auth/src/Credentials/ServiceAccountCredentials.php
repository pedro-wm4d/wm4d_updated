...
class ServiceAccountCredentials extends CredentialsLoader
{
    ...
    public function __construct($scope, $jsonKey, $sub = null)
    {
        ...
        $this->auth = new OAuth2(array('audience' => self::TOKEN_CREDENTIAL_URI, 'issuer' => $jsonKey['client_email'], 'scope' => $scope, 'signingAlgorithm' => 'RS256', 'signingKey' => $jsonKey['private_key'], 'sub' => $sub, 'tokenCredentialUri' => self::TOKEN_CREDENTIAL_URI));
    }
    /**
