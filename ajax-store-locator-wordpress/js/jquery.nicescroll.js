    ...
    var s = false,
        ...
        E = function () {
            ...
            for (var h = ["transform", "msTransform",
                "webkitTransform", "MozTransform", "OTransform"], i = 0; i < h.length; i++) if (typeof d.style[h[i]] != "undefined") {
                c.trstyle = h[i];
                break
            }
            ...
            o = "transitionend,webkitTransitionEnd,transitionend,otransitionend,oTransitionEnd,msTransitionEnd,KhtmlTransitionEnd".split(","), i = 0; i < h.length; i++) if (h[i] in d.style) {
                        ...
                        if (e.cantouch || b.istouchcapable || b.opt.touchbehavior || e.hasmstouch) {
                            ...
                            b.ontouchmove = function (c, f) {
                                ...
                                if (b.rail.drag && b.rail.drag.pt == 2) {
                                    ...
                                    else if (h < 0 && (d = h = 0), h > b.page.maxh) h = b.page.maxh, d = 0;
                                    var i = c.clientX + g;
            ...
            this.onResize = function (c, e) {
                ...
                if (!b.haswrapper && !b.ispage) if (b.win.css("display") == "none") return b.visibility && b.hideRail().hideRailHr(), false;
                ...
                if (b.page.maxh == g && b.page.maxw == d && b.view.w == h) if (b.ispage) return b;
                else {
                    g = b.win.offset();
