...
/*                        if (i == 0) console.log(markers[i]);*/
    ...
    function SearchStore(lat, lan, rad, RadType, CateId) {
        ...
        var loadAdwords = jQuery('#sloc_LoadAdwords').attr("checked")=="checked";
		...
		jQuery.ajax({
			...
			beforeSend: function (x) {
				...
				var customElement   = $("<div>", {
					...
					text    : 'Loading Adwords data - Please wait',
				});
				$("#sloc_rightContent").LoadingOverlay("show", {custom  : customElement});

/*				$("#sloc_rightContent").LoadingOverlay("show");*/
			},
...
*/
 ?>
								<input id="sloc_LoadAdwords" class="wd75c" name="sloc_LoadAdwords" type="checkbox" value="yes" checked="checked"/><label for="sloc_LoadAdwords">Show Adwords Data</label> 
